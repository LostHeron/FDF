...
/*   Updated: 2025/04/21 12:07:31 by jweber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	other_view(int keycode, t_data *ptr_data);
...
int	key_hook_shift(int keycode, t_data *ptr_data)
{
	...
	if (heights(keycode, ptr_data) == 0)
		return (0);
	if (other_view(keycode, ptr_data) == 0)
		return (0);
	return (0);
}
...
static int	other_view(int keycode, t_data *ptr_data)
{
	if (keycode == XK_w)
	{
		ptr_data->angle_x = (PI * (90 + 180) / 180);
		ptr_data->angle_y = 0;
		ptr_data->angle_z = 0;
		set_rot_x(ptr_data);
		set_rot_y(ptr_data);
	...
	{
		ptr_data->angle_x = 0;
		ptr_data->angle_y = (PI * (90 + 180) / 180);
		ptr_data->angle_z = 0;
		set_rot_x(ptr_data);
		set_rot_y(ptr_data);
		set_rot_z(ptr_data);
	...
	if (keycode == XK_r)
	{
		ptr_data->angle_x = 0;
		ptr_data->angle_y = 0;
		ptr_data->angle_z = (PI * (90 + 180) / 180);
		set_rot_x(ptr_data);
		set_rot_y(ptr_data);
		set_rot_z(ptr_data);
		set_rot_mat(ptr_data);
